...
#' @param top_n         Integer number of recommended pairs to display.
...
plot_grna_design <- function(exon_gr,
  ...
  if (length(exon_gr) > 12) {
    ...
    return(plot_grna_heatmap(exon_gr, gene_symbol, transcript_id))
  }
  ...
  ## ----- 2. Multi-exon plotting mode (standard) -----
